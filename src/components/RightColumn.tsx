...
const AI_ANSWER = `基于您提供的视频，我总结了以下几点核心内容：

应急处理（按过敏严重程度）

1. 立即停药
停止青霉素输注/注射，保留静脉通路，更换输液器与生理盐水。

2. 立即通知医生（同步进行，不中断抢救）
- 第一时间呼叫医生/启动急救团队，同时报告病情（用药名称、反应表现、发生时间）。
- 关键分寸：根据《护士条例》第十七条，遇患者病情危急应立即通知医师；在医生未到场前，护士可先行实施必要的紧急救护（如平卧、给氧、按抢救预案给予肾上腺素等），不得因等待医嘱而延误抢救。
- 医生到场后，立即汇报已执行的措施与患者反应，配合后续抢救；口头医嘱须复述核对后执行，事后督促医生 6 小时内补记。

3. 评估与体位
- 过敏性休克：平卧、下肢抬高、保持气道通畅；
- 呼吸困难者高流量吸氧，喉头水肿准备气管插管/环甲膜穿刺。

4. 首选抢救药：肾上腺素
- 按教材步骤：立即皮下注射或深部肌内注射 0.1% 盐酸肾上腺素 0.5 mL；小儿按 0.01 mg/kg 体重计算，单次最大剂量 0.3 mL；
- 症状如不缓解，每隔 15 min 可重复皮下或深部肌内注射该药 0.5 mL，直至脱离危险期；
- 肾上腺素是抢救过敏性休克的首选药物，不能用激素或抗组胺药代替。
...
6. 监测与记录
持续测 BP、P、R、SpO₂、神志；记录过敏发生时间、通知医生时间、用药、反应、处理经过；填写不良事件上报护理部/药剂科。

7. 留观
轻度皮疹也至少观察 24 h；严重过敏转 ICU。`;

const GUIDELINE_NOTE = "指南补充（小字）：在教材“皮下注射或深部肌内注射、15 min 可重复”的教学表述基础上，现行权威建议（AAAAI/ACAAI 2023、ASCIA 2024、RCUK 2021）更倾向将大腿中外侧/前外侧肌内注射作为首选，并建议气道/呼吸/循环问题持续时约 5 min 后重新评估。此处指南用于补充临床新进展，教材步骤仍为本页面主体；具体执行以本院抢救预案、药品说明书及医嘱为准。";
